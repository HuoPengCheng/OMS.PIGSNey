...
using OMS.PIGSNey.Models.TokenAuth;
...
{
    public abstract class PIGSNeyWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static PIGSNeyWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(PIGSNeyWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<PIGSNeyDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<PIGSNeyDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<PIGSNeyDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<PIGSNeyDbContext, Task<T>> func)
        {
            T result;
